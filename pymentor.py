...
with st.sidebar:
    ...
    st.markdown("Assistente de Python criada para ajudar você a entender código, resolver exercícios e corrigir erros de forma clara e direta.")
...
st.title("🐍📊 PyMentor — Seu guia em Python")
    ...
    with st.chat_message("assistant"):
        ...
        with st.spinner("Analisando sua pergunta..."):
            ...
            try:
                ...
                pymentor_resposta = chat_completion.choices[0].message.content
                
                # Exibe a resposta no Streamlit
                st.markdown(pymentor_resposta)
                
                # Armazena resposta do assistente no estado da sessão
                st.session_state.messages.append({"role": "assistant", "content": pymentor_resposta})
